...
read_time: 9 min
description: >
  Group Policy confusion is almost always about precedence, not syntax —
  the resolution order I sketch for every student, plus the one command
  that ends most arguments.
---
